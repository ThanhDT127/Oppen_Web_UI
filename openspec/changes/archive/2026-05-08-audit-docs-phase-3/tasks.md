...
- [x] 3.2 Sửa dashboard URL: `http://<server>:5000/dashboard` → `https://openwebui.rangdong.com.vn:51122/dashboard`.
...
- [x] 4.3 Sửa curl examples: `http://192.168.20.66:5000` → `http://localhost:5000`, `Authorization: Bearer` → `X-Admin-Key: $ADMIN_KEY`.
