...
1. **CORS misconfiguration**: `allow_origins` chỉ chấp nhận `https://openwebui.example.com:51122` — browser preflight requests bị block khi user mở Settings → Connections và giao diện gọi trực tiếp tới middleware
