...
1. **CORS blocking**: Middleware chỉ cho phép origin `https://openwebui.rangdong.com.vn:51122` nhưng khi Open WebUI server-side forward request, nó sử dụng internal Docker hostname (`http://middleware:5000`) — không match CORS.
