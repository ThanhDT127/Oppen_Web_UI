# personal-integration-tools Specification

## Purpose
Các tool chạy dưới OAuth token cá nhân của người dùng (GitHub, Google Drive), phân định với office365 do MCP phụ trách.
