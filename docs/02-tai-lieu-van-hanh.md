...
```
    ...
    ║  │  SSL: wildcard *.example.com (TLS 1.2/1.3)          │   ║
...
| 07  | SSL        | —            | **Wildcard cert *.example.com** |
...
curl "http://localhost:5000/v1/_mw/access_summary?minutes=1440" -H "X-Admin-Key: YOUR_ADMIN_KEY"
