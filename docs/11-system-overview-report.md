...
Truy cập: `https://openwebui.example.com:51122/dashboard`
...
| 2   | Kiểm tra chi phí  | Dashboard (`https://openwebui.example.com:51122/dashboard`) |
...
| 06  | Đa model          | Chỉ OpenAI              | **5 providers** (21 models)         |
...
| --- | ---------------------------- | --------------------------------------------------- | --------------------- |
| 01  | Open WebUI (giao diện chính) | `https://openwebui.example.com:51122`           | Qua Nginx HTTPS       |
| 02  | Middleware Dashboard         | `https://openwebui.example.com:51122/dashboard` | Chỉ Admin, qua Nginx  |
| 03  | API Endpoint                 | `https://openwebui.example.com:51122/v1/_mw/`   | Cho tích hợp ứng dụng |
