...
- **API Key**: `subkey_admin_123` (hoặc `subkey_user1_abc`)
...
**Subkey nào dùng?**
- `subkey_admin_123`: Không giới hạn quota (admin)
- `subkey_user1_abc`: Giới hạn 200k tokens/tuần, $10 USD
...
**Giải pháp**:
- ❌ Không dùng: `super_admin_key_123`, `LITELLM_KEY`
- ✅ Phải dùng: `subkey_admin_123` hoặc `subkey_user1_abc`
...
- [ ] API Key dùng subkey: `subkey_admin_123`
