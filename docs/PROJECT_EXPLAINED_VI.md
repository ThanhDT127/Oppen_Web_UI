...
Invoke-WebRequest http://localhost:5000/v1/chat/completions -Method Post -Headers @{"Authorization"="Bearer YOUR_SUBKEY_ADMIN"; "Content-Type"="application/json"} -Body $body
