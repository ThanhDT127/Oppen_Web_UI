...
│  │  │  - Chat AI da mo hinh (text, image, audio)                            │   │  │
│  │  │  - Quan ly ho so & xac thuc nguoi dung                                │   │  │
│  │  │  - Lich su hoi thoai & tim kiem RAG                                   │   │  │
│  │  └──────────────────────────────┬────────────────────────────────────────┘   │  │
│  │                                 │ OpenAI API Format                          │  │
│  │                                 ▲                                            │  │
│  │                                 │                                            │  │
...
│  │  │                                              │   │                     │  │  │
│  │  │  - Proxy AI: Chat, Image, Audio              │   │ Du lieu nguoi dung  │  │  │
│  │  │    (stream & non-stream)                     │   │  - Tai khoan/Subkey │  │  │
│  │  │                                              │   │  - Han muc (Quota)  │  │  │
│  │  │  - Admin Dashboard                           │   │                     │  │  │
│  │  │    Bieu do, thong ke, top users/models       │   │ Bang gia model      │  │  │
│  │  │                                              │   │  - Cost/token input │  │  │
│  │  │  - Quan ly User & Quota                      │◄-►│  - Cost/token output│  │  │
│  │  │    Tao/sua/xoa user, cap phat han muc        │   │                     │  │  │
│  │  │                                              │   │ Audit & Log         │  │  │
│  │  │  - Kiem toan (Audit)                         │   │  - Lich su request  │  │  │
│  │  │    Ghi log kep (DB + file), realtime SSE     │   │  - Chi phi & tokens │  │  │
│  │  │                                              │   │  - Loi & latency    │  │  │
│  │  │  - Tinh chi phi (Cost Tracking)              │   │                     │  │  │
│  │  │    Tu dong tinh $/token theo bang gia        │   │ Cau hinh he thong   │  │  │
│  │  │                                              │   │  - Nguong canh bao  │  │  │
│  │  │  - Xac thuc & Bao mat                        │   │  - Request dang cho │  │  │
...
│  │  │  - Doi ten model: chat-gpt-5 -> openai/gpt-5 (23 models)              │   │  │
│  │  │  - Dinh tuyen da nha cung cap (OpenAI, Gemini, Grok, ...)             │   │  │
│  │  └──────────────────────┬────────────────────────────────────────────────┘   │  │
│  │                         │                                                    │  │
│  └─────────────────────────┼────────────────────────────────────────────────────┘  │
│                            │                                                       │
