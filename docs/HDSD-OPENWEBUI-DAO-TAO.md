...
2. Điền thông tin:
   ...
   - **Email:** Email công ty (ví dụ: vana@rangdong.com.vn)
...
| API hoạt động? | Gọi `curl https://openwebui.rangdong.com.vn:51122/v1/models` |
...
| Dịch vụ | URL |
|---------|-----|
| Open WebUI (Chat) | `https://openwebui.rangdong.com.vn:51122/` |
| Dashboard (Admin) | `https://openwebui.rangdong.com.vn:51122/dashboard` |
| Nội bộ LAN | `https://192.168.20.66:3000/` |
