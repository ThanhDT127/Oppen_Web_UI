...
|---------|-----|-----------|
| Chat AI | `https://openwebui.rangdong.com.vn:51122/` | Tất cả users |
| Dashboard Admin | `https://openwebui.rangdong.com.vn:51122/dashboard` | Admin |
| API Endpoint | `https://openwebui.rangdong.com.vn:51122/v1/` | Tích hợp |
| Nội bộ (LAN) | `https://192.168.20.66:3000/` | Truy cập trực tiếp |
